const Testimonials = () => {
  return (
    <>
    <section className="text-gray-600 body-font bg-yellow-500 mt-48">
  <div className="container px-32 py-24 mx-auto">
    <h1 className="text-3xl font-bold title-font text-white mb-12 text-center">Customer Testimonials</h1>
